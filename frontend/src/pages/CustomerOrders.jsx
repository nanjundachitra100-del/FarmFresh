    ...
    switch (status) {
      case 'Pending':
        return (
          <Clock
            size={18}
            className="status-icon pending-color"
          />
        );
      ...
      case 'In Transit':
        return (
          <Truck
            size={18}
            className="status-icon transit-color"
          />
        );
      ...
      case 'Delivered':
        return (
          <CheckCircle
            size={18}
            className="status-icon delivered-color"
          />
        );
  ...
  return (
    ...
    >
      ...
      {showSuccessBanner && (
        <div className="success-banner-alert animate-banner">
          ...
          <div className="banner-text">
            ...
            <p>
              Your payment was simulated via x402 protocol.
              The farmer has been notified and will prepare
      ...
      <header className="orders-header">
        ...
        <p>
          Monitor your purchases, track statuses, and view
      ...
      {customerOrders.length > 0 ? (
        <div
          className="orders-timeline-list"
          id="orders-list"
        >
              ...
              >
                ...
                <div className="order-card-body">
                  ...
                  <div className="order-items-grid">
                    <span className="items-title-order">
                      Ordered Items
                    </span>
                ...
                <div className="order-card-footer">
                  ...
                  <div className="order-total-amount">
                    <span className="total-label-order">
                      Total Amount:
                    </span>
        ...
        <div className="no-orders-box">
          <span className="no-orders-emoji">
            📦
          </span>
          ...
          <p>
            ...
            Head over to our catalog to buy fresh
            produce directly from our local farmers.
          </p>

          <Link
            to="/products"
            className="shop-btn-no-orders"
          >
            Shop Fresh Produce
          </Link>
        </div>
